...
public struct InputAction
{
    ...
    [Pure]
    public static explicit operator string(InputAction inputAction) => inputAction.Name;
    [Pure]
    public static implicit operator InputAction(string name) => new InputAction(name);
}
}