...
public class StateMalformedException : Exception
{
    ...
    public StateMalformedException(string message) : base(message)
    {
    }

    public StateMalformedException(string message, Exception innerException) : base(message, innerException)
    {
    }
}

/// <summary>
/// This exception is to indicate an exception that should never be thrown. If it is, there is something wrong or there is a
/// bUg
/// </summary>
public class ShouldNotHappenException : Exception
{
    ...
    public ShouldNotHappenException(Exception innerException) : base(DefaultMessage, innerException)
    {
    }
