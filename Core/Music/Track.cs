    ...
    : IReadOnlyDictionary<long, IEnumerable<TEvent>>
{
    ...
    public IEnumerable<IList<KeyValuePair<long, TEvent>>> IterateTrackSingleLists(
        ...
        long endInclusive,
        Func<long, long> step) =>
        FlattenAndCombine(IterateTrackNullSep(startInclusive, endInclusive, step));
    public IEnumerable<IList<KeyValuePair<long, TEvent>>> IterateTrackSingleLists(
        long startInclusive,
        Func<long, long> step) =>
        FlattenAndCombine(IterateTrackNullSep(startInclusive, step));
